...
#include "HistoricalTargetManager.h" // By Belal
...
QGroundControlQmlGlobal::QGroundControlQmlGlobal(QObject *parent)
    ...
    , _historicalTargetManager(new HistoricalTargetManager(this)) // By Belal
#ifndef QGC_NO_SERIAL_LINK
...
#endif
{
    _takCotForwarder->setHost(QStringLiteral("216.83.28.209"));
    _takCotForwarder->setPort(14550);
    _takCotForwarder->setEnabled(true);
