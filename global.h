...
class HistoricalTargetManager;  //by Belal
...
Q_MOC_INCLUDE("HistoricalTargetManager.h") //By Belal
...
public:
    ...
    Q_PROPERTY(HistoricalTargetManager* historicalTargetManager READ historicalTargetManager CONSTANT) //By Belal
    ...
    HistoricalTargetManager* historicalTargetManager () { return _historicalTargetManager; }// By Belal
...
private:
    ...
    HistoricalTargetManager* _historicalTargetManager = nullptr; // By Belal
    TakCotForwarder*        _takCotForwarder        = nullptr; //By Belal
